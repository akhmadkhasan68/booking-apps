...
<head>
    ...
    <link href="{{ secure_asset('sbadmin2/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
...
@yield('content')
    ...
    <script src="{{ secure_asset('sbadmin2/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ secure_asset('sbadmin2/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{ secure_asset('sbadmin2/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ secure_asset('sbadmin2/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ secure_asset('sbadmin2/vendor/chart.js/Chart.min.js') }}"></script>
